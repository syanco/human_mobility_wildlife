...
# ------------ Area Intra-Individual Interactive Analysis Raondom Slopes ------------

echo "STARTING SCRIPT: fit_intra_ind_int_mod_random_slopes_space.r"

Rscript $src/fit_intra_ind_int_mod_random_slopes_space.r $wd/out/dbbmm_size.csv $wd/out/intra_ind_models 12 10000 5
...
Rscript $src/fit_intra_ind_add_mod_random_slopes_space.r $wd/out/dbbmm_size.csv $wd/out/intra_ind_models 12 10000 2

echo "SCRIPT COMPLETE: fit_intra_ind_add_mod_random_slopes_space.r"

echo "JOB COMPLETE: rs_a"